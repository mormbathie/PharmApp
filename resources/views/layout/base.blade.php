...
<html lang="fr">
  <head>
    ...
    <title>PharmApp - @yield('titre')</title>
...
<meta name="theme-color" content="#7952b3">
    ...
    <link href="{{ asset('css/mormbathie.css') }}" rel="stylesheet">
  </head>
  <body class="bg-light">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link " aria-current="page" href="{{route('index')}}">Acceuil</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="{{route('view')}}">Liste</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <footer class="py-2 bg-light fixed-bottom">
        ...
        <p class="m-0 text-center text-dark">&#169;
            vous pouvez me contacter sur le numero : 77 459 59 70 ou 76 181 97 50
            ou mormbathie98@gmail.com ou mormbathie33@gmail.com
        </p>
        <p class="m-0 text-end text-dark">&#169;
            mormbathie</p>
        </div>
        </footer>
